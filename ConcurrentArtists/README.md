...
Starvation is a fail-safe method in order to get out of a deadlock. And the reason we can get a starvation is because there is not enough resources to go around, and the process start becoming low. The way we can fix this is through aging, which is a techniique that increases the priority level of low priority.
...
I sat down and I looked through assembly code. I watched a couple of youtube videos as well as went through a couple of the web pages once I googled Assembly language. It helped but i can honestly state I am still not fully comfortbale to actually use it however I did understand more then what I initially knew. 
...
2. Do not commit your .o file or your executable file to the repository, this is considered bad practice!3. On Functionality/Style
